...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Aj cutzz.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        }
...
const array = ['Pikachu','Msd','Vijay','Rashmika','song','Sry','Line','Aarulle','achodaa','ayin','Aysheri','Ayye','Ayyo','broken','bye','chattho','cute','Da','Eee','engane und','Entha','Enthada','Girls','Good morning','Good night','Hi','Hy','ithokke enth','ivan','Kurippe','Kurumb','Love','Mm','naanam','nadakkatte','Ok','paavam','Pattumo','pikachu','Pm','poda','Pova','Save','setth','sho','Shoo','Smile','tag','Udayipp','umma','Vaa','Vannu','yo','ys','Bye','Muthe','Police','Teach','Thech','Z','aayo','alla','anthas','aysheri','bie','bye','chathu','cheyalle','chunk','committed','mama','marichu','mention','mood','muthe','myre','njan','number','ok','oombi','ooo','pedicho','pidi','poweresh','sad','saved','sed','shaad','shut','teach','test','thech','think','thund','umma','uyir','vannu','vibe','z','dead','JulieMwol','Like','pever','sry','night','indo','uff','eh','poyi','scene','killadi','nee Araa','Aj cutzz','Alfred','Baby','Bgmi','Blind','Bot sed','Chirikkano','Chunk uyir','Cr7','cr7','Darshana','E bull jet','Editing','Eivan nashichu','Exam','Fan','From','gn','Hello','I love you','Kanav bgm','Kannappi','Kili','Kuttu','Love you molu','Mamman','Nadakko','Namban','Nb','Njan','Njan eilla','Njan ano','Njan killadi alle','Njan nannayi','Njan poyi','Njr','Of','Ok','Oo','Pavan','Pc mp4','Poda panni','Podimon','Pova','Power','Rip','Sad','Supper','Uyir','test','thech','think','thund','umma','uyir','Welcom']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
